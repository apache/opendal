...
using DotOpenDAL.Interop.Marshalling;
using DotOpenDAL.Interop.Result.Abstractions;

namespace DotOpenDAL.Interop.Result;

[StructLayout(LayoutKind.Sequential)]
internal struct OpenDALPresignedRequestResult : INativeValueResult<PresignedRequest>
{
    public IntPtr Ptr;
    ...
    {
        NativeMethods.opendal_presigned_request_result_release(this);
    }
