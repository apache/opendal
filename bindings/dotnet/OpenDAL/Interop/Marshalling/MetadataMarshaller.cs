...
internal static class MetadataMarshaller
{
    ...
    {
        return new Metadata(
            Utilities.ToEntryMode(payload.Mode),
            payload.IsCurrentHasValue != 0 ? payload.IsCurrent != 0 : null,
            payload.IsDeleted != 0,
            ...
            payload.LastModifiedHasValue != 0 ? Utilities.ToDateTimeOffset(payload.LastModifiedSecond, payload.LastModifiedNanosecond) : null,
            ...
            payload.UserMetadataHasValue != 0 ? Utilities.ReadStringPairs(payload.UserMetadataKeys, payload.UserMetadataValues, payload.UserMetadataLen, StringComparer.Ordinal) : null
        );
    }
}
