...
internal struct OpenDALCapability
{
    ...
    [MarshalAs(UnmanagedType.U1)] internal byte compose;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithContentType;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithContentDisposition;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithContentEncoding;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithCacheControl;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithUserMetadata;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithIfMatch;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithIfNoneMatch;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithIfVersionMatch;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithIfVersionNotMatch;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithIfNotExists;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithSourceVersion;
    [MarshalAs(UnmanagedType.U1)] internal byte composeWithSourceIfMatch;
