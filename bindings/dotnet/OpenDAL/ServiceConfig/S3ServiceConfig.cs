...
namespace OpenDAL.ServiceConfig
{
    ...
    public sealed class S3ServiceConfig : IServiceConfig
    {
        ...
        /// </summary>
        public int? AssumeRoleDurationSeconds { get; init; }
        /// <summary>
        /// Deprecated: S3 delete batch capability is enabled by default.
        /// </summary>
        [System.Obsolete("S3 delete batch capability is enabled by default. Use CapabilityOverrideLayer to override delete_max_size for specific endpoints.")]
        ...
        /// </summary>
        [System.Obsolete("S3 stat override capabilities are enabled by default. Use CapabilityOverrideLayer to override them for specific endpoints.")]
        public bool? DisableStatWithOverride { get; init; }
        /// <summary>
        /// Deprecated: S3 write with If-Match capability is enabled by default.
        /// </summary>
        [System.Obsolete("S3 write with If-Match capability is enabled by default and this option is no longer needed.")]
        ...
        /// </summary>
        [System.Obsolete("S3 versioning capability is enabled by default and this option is no longer needed.")]
        ...
        /// </summary>
        [System.Obsolete("S3 append capability is enabled by default and this option is no longer needed.")]
...
#pragma warning restore CS0618
            if (AssumeRoleDurationSeconds is not null)
            {
                map["assume_role_duration_seconds"] = Utilities.ToOptionString(AssumeRoleDurationSeconds);
            }
#pragma warning disable CS0618
...
#pragma warning restore CS0618
            ...
            if (DefaultAcl is not null)
            {
                map["default_acl"] = Utilities.ToOptionString(DefaultAcl);
            }
...
#pragma warning restore CS0618
            ...
            {
                map["profile"] = Utilities.ToOptionString(Profile);
            }
