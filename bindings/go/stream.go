...
func (w *Writer) ReadFrom(src io.Reader) (int64, error) {
	// The wrappers expose only Read and Write.
	// Thus, CopyBuffer cannot call ReadFrom again or use src.WriteTo.
...
func (r *Reader) WriteTo(dst io.Writer) (int64, error) {
	// The wrappers expose only Read and Write.
	// Thus, CopyBuffer cannot call WriteTo again or use dst.ReadFrom.
