...
public interface ServiceConfig {
    ...
    class Hf implements ServiceConfig {
         ...
         * <code>/resolve</code> again. Default <code>10s</code>; <code>0s</code> disables the cache.</p>
         * <p>A write or delete through this operator discards the cache outright,
         * so it never hides your own changes. This bounds how long a change made
         * <em>elsewhere</em> to a floating revision such as <code>main</code> stays invisible.</p>
         */
