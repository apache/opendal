...
val new_operator :
  string ->
  (string * string) list ->
  (Opendalinner.Operator.operator, string) result
...
val is_exist : Opendalinner.Operator.operator -> string -> (bool, string) result
...
val create_dir :
  Opendalinner.Operator.operator -> string -> (bool, string) result
...
val read :
  Opendalinner.Operator.operator -> string -> (char array, string) result
...
val write :
  Opendalinner.Operator.operator -> string -> bytes -> (unit, string) result
...
val copy :
  Opendalinner.Operator.operator -> string -> string -> (unit, string) result
...
val delete : Opendalinner.Operator.operator -> string -> (unit, string) result
...
val remove :
  Opendalinner.Operator.operator -> string array -> (unit, string) result
...
val remove_all :
  Opendalinner.Operator.operator -> string -> (unit, string) result
