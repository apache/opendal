...
/// # Requirements
///
/// Services that implement `MultipartWrite` must fulfill the following requirements:
///
/// - Must be a http service that could accept `AsyncBody`.
/// - Don't need initialization before writing.
/// - Upload ID is generated by the service via `initiate_part`.
/// - Complete upload by an ordered part list.
