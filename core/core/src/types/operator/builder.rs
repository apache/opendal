...
use crate::layers::{
    CompleteLayer, CorrectnessCheckLayer, ErrorContextLayer, SimulateLayer, TypeEraseLayer,
};
use crate::raw::*;
...
impl Operator {
    ...
    pub fn via_iter(
        ...
        let uri = OperatorUri::from_parts(scheme.as_ref(), iter)?;
        super::registry::default_operator_registry().load(uri)
    }
