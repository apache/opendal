...
pub fn parse_wasi_error(code: ErrorCode) -> Error {
    let (kind, message) = match code {
        ...
        ErrorCode::FileTooLarge => (ErrorKind::Unexpected, "File too large"),
        ErrorCode::IllegalByteSequence => (ErrorKind::Unexpected, "Invalid byte sequence"),
        ...
        ErrorCode::Invalid => (ErrorKind::Unexpected, "Invalid argument"),
        ...
        ErrorCode::MessageSize => (ErrorKind::Unexpected, "Message too large"),
        ErrorCode::NameTooLong => (ErrorKind::Unexpected, "Name too long"),
        ...
        ErrorCode::InsufficientSpace => (ErrorKind::Unexpected, "No space left on device"),
        ...
        ErrorCode::InvalidSeek => (ErrorKind::Unexpected, "Invalid seek"),
