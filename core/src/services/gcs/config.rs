...
mod tests {
    ...
    fn test_direct_client_config_keys() {
        ...
        config_map.insert(
            "allow_invalid_certificates".to_string(),
            "false".to_string(),
        );
        config_map.insert(
        ...
        config_map.insert(
            "proxy_ca_certificate".to_string(),
            "-----BEGIN CERTIFICATE-----\ntest\n-----END CERTIFICATE-----".to_string(),
        );
        config_map.insert(
            "proxy_excludes".to_string(),
    ...
    fn test_google_prefixed_config_keys() {
        ...
        config_map.insert(
            "google_allow_invalid_certificates".to_string(),
            "true".to_string(),
        );
        config_map.insert(
            "google_default_content_type".to_string(),
            "text/plain".to_string(),
        );
        config_map.insert(
            "google_pool_max_idle_per_host".to_string(),
            "20".to_string(),
        );
        config_map.insert(
            "google_proxy_url".to_string(),
            "https://google-proxy.example.com:3128".to_string(),
        );
        config_map.insert(
            "google_proxy_ca_certificate".to_string(),
            "-----BEGIN CERTIFICATE-----\ngoogle-cert\n-----END CERTIFICATE-----".to_string(),
        );
        config_map.insert(
            "google_proxy_excludes".to_string(),
            "internal.company.com,localhost".to_string(),
        );
        config_map.insert("google_randomize_addresses".to_string(), "true".to_string());
        config_map.insert(
            "google_user_agent".to_string(),
            "GoogleTestApp/2.0".to_string(),
        );
        ...
        assert_eq!(
            config.proxy_url,
            Some("https://google-proxy.example.com:3128".to_string())
        );
        assert!(config.proxy_ca_certificate.is_some());
        assert_eq!(
            config.proxy_excludes,
    ...
    fn test_legacy_aliases() {
        ...
        config_map.insert(
            ...
            "google-test@example.iam.gserviceaccount.com".to_string(),
        );
        config_map.insert(
            "service_account_key".to_string(),
            "base64-encoded-key".to_string(),
        );
        config_map.insert(
        ...
        assert_eq!(
            ...
            Some("google-test@example.iam.gserviceaccount.com".to_string())
        );
    ...
    fn test_mixed_configuration_patterns() {
        ...
        config_map.insert(
            "google_proxy_url".to_string(),
            "https://mixed-proxy.example.com:8080".to_string(),
        ); // prefixed
        config_map.insert("user_agent".to_string(), "MixedApp/1.5".to_string()); // direct
        config_map.insert(
            "service_account_path".to_string(),
            "/mixed/path/creds.json".to_string(),
        ); // legacy alias
        config_map.insert(
            "google_randomize_addresses".to_string(),
            "false".to_string(),
        ); // prefixed
    ...
    fn test_edge_cases_and_defaults() {
        ...
        if let Ok(config) = GcsConfig::from_iter(bool_config) {
            ...
            println!(
                "Boolean parsing test passed: allow_http={}",
                config.allow_http
            );
        }
        ...
        assert!(
            GcsConfig::from_iter(invalid_config).is_err(),
            "Invalid numeric value should cause parsing to fail"
        );
    }
    ...
    fn test_comprehensive_configuration() {
        ...
        config_map.insert(
            "endpoint".to_string(),
            "https://custom-gcs-endpoint.example.com".to_string(),
        );
        config_map.insert(
        ...
        config_map.insert(
            "predefined_acl".to_string(),
            "bucketOwnerFullControl".to_string(),
        );
        ...
        config_map.insert(
            "proxy_url".to_string(),
            "https://comprehensive-proxy.example.com:8080".to_string(),
        );
        config_map.insert(
            "google_proxy_excludes".to_string(),
            "*.internal.com,localhost,127.0.0.1".to_string(),
        );
        config_map.insert("randomize_addresses".to_string(), "true".to_string());
        config_map.insert(
            "user_agent".to_string(),
            "ComprehensiveTestApp/3.0".to_string(),
        );

        let config =
            GcsConfig::from_iter(config_map).expect("Failed to parse comprehensive config");

        // Verify GCS specific settings
        assert_eq!(config.bucket, "comprehensive-bucket");
        assert_eq!(
            config.endpoint,
            Some("https://custom-gcs-endpoint.example.com".to_string())
        );
        assert_eq!(
            config.service_account,
            Some("test@example.iam.gserviceaccount.com".to_string())
        );
        assert_eq!(
            config.credential_path,
            Some("/path/to/service-account.json".to_string())
        ...
        assert_eq!(
            config.proxy_url,
            Some("https://comprehensive-proxy.example.com:8080".to_string())
        );
        assert_eq!(
            config.proxy_excludes,
    ...
    fn test_object_store_migration_compatibility() {
        ...
        object_store_config.insert(
            "google_bucket".to_string(),
            "migration-test-bucket".to_string(),
        );
        object_store_config.insert(
            "google_service_account".to_string(),
            "migration@example.iam.gserviceaccount.com".to_string(),
        );
        object_store_config.insert(
            "google_service_account_path".to_string(),
            "/migration/path/service-account.json".to_string(),
        );
        object_store_config.insert("google_allow_http".to_string(), "true".to_string());
        object_store_config.insert(
            "google_proxy_url".to_string(),
            "https://migration-proxy.example.com:3128".to_string(),
        );
        object_store_config.insert(
            "google_user_agent".to_string(),
            "MigrationTestApp/1.0".to_string(),
        );
        ...
        assert_eq!(
            config.service_account,
            Some("migration@example.iam.gserviceaccount.com".to_string())
        );
        assert_eq!(
            config.credential_path,
