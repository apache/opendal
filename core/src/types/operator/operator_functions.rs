...
///
/// Users can add more options by public functions provided by this struct.
pub struct FunctionRead(pub(crate) OperatorFunction<(OpRead, BytesRange, OpReader), Buffer>);
...
impl FunctionRead {
    ...
    pub fn range(mut self, range: impl RangeBounds<u64>) -> Self {
        self.0 = self
            .0
            .map_args(|(args, _, options)| (args, range.into(), options));
        self
    }
...
pub struct FunctionReader(
    pub(crate) OperatorFunction<(OpRead, BytesRange, OpReader), BlockingReader>,
);
...
impl FunctionReader {
    ...
    pub fn override_content_disposition(mut self, content_disposition: &str) -> Self {
        self.0 = self.0.map_args(|(args, range, options)| {
            (
    ...
    pub fn override_cache_control(mut self, cache_control: &str) -> Self {
        self.0 = self.0.map_args(|(args, range, options)| {
            (
                args.with_override_cache_control(cache_control),
                range,
                options,
            )
        });
    ...
    pub fn override_content_type(mut self, content_type: &str) -> Self {
        self.0 = self.0.map_args(|(args, range, options)| {
            (
                args.with_override_content_type(content_type),
                range,
                options,
            )
        });
    ...
    pub fn if_match(mut self, v: &str) -> Self {
        self.0 = self
            .0
            .map_args(|(args, range, options)| (args.with_if_match(v), range, options));
        self
    }
    ...
    pub fn if_none_match(mut self, v: &str) -> Self {
        self.0 = self
            .0
            .map_args(|(args, range, options)| (args.with_if_none_match(v), range, options));
        self
    }
    ...
    pub fn version(mut self, v: &str) -> Self {
        self.0 = self
            .0
            .map_args(|(args, range, options)| (args.with_version(v), range, options));
        self
    }
