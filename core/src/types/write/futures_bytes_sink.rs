...
/// FuturesBytesSink is the adapter of [`Sink`] generated by [`Writer::into_bytes_sink`].
///
/// Users can use this adapter in cases where they need to use [`Sink`] trait. FuturesBytesSink
