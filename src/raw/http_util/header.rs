...
/// parse_into_object_metadata will parse standards http headers intooutput::Metadata.
///
/// # Notes
///
...
/// metadata on demand.
pub fn parse_into_object_metadata(path: &str, headers: &HeaderMap) -> Result<output::Metadata> {
