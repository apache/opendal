Apache OpenDAL provides [Rust Core](/docs/rust/opendal) and builds different langauge bindings like [Node.js Binding](/docs/nodejs) and [Python Binding](/docs/python).
